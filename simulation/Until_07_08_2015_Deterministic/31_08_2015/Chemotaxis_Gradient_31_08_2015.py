...
def tumble(current_position,world_size):
    if 0<=current_position[0]<=world_size and 0<=current_position[1]<=world_size:
...
ncells=100
size=2000
simtime=2000        #Seconds to simulate for
...
for i in np.arange(0,ncells,1):
    ...
    #axis.add_patch(patches.Ellipse((0,0],POS[(0,1]),20,20,facecolor='blue'))
