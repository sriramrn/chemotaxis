# -*- coding: utf-8 -*-
"""
Created on Sun Sep  6 19:02:48 2015
...
#Load the evolved strategy
loadfile='E:/Work/Rotation/06_09_2015/evolution_velocity0/evolution_velocity0_best.csv'
velocity_mutation=np.genfromtxt(loadfile, delimiter=',')
...
for i in np.arange(0,ncells,1):
    ...
    while t<simtime:    
        ...
        #runduration=update_runduration_with_concentration(concentration,duration_mutation,sensor_max)
        runvelocity=update_runvelocity_with_concentration(concentration,velocity_mutation,sensor_max)
        vdt=runvelocity*dt
