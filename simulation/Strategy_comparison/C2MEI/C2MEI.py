# -*- coding: utf-8 -*-
"""
Created on Wed Sep 16 10:06:22 2015
...
save='yes' #yes or no
datapath='E:/Work/Rotation/Comparison/C2MEI/'
filename='C2MEIVDS'
...
for i in np.arange(0,ncells,1):
    ...
    while t<simtime+init_runduration:    
        ...
        if strategy=='D':
            runduration=ct.update_runduration_like_Ecoli(concentration,init_runduration,sensor_max,
        ...
        if strategy=='V':        
            runvelocity=ct.update_runvelocity_like_Ecoli(concentration,init_runvelocity,sensor_max,
