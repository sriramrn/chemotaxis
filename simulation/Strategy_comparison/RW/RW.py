# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 11:48:18 2015
...
save='no' #yes or no
datapath='E:/Work/Rotation/Poster/RW/'
filename='RWR'
...
max_d,max_v,gradient_memory,attractant_source,gtau)
...
parameters=[[ncells,size,simtime,runduration,runvelocity,turn_direction],['ncells','size',
            'simtime','runduration','runvelocity','turn angle','Random Walk']] 
