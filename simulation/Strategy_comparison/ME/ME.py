# -*- coding: utf-8 -*-
"""
Created on Sat Sep 12 17:53:10 2015
...
save='no' #yes or no
datapath='E:/Work/Rotation/Comparison/ME/'
filename='MEVDS'
...
for i in np.arange(0,ncells,1):
    ...
    while t<simtime+init_runduration:    
        ...
        gradient_memory=ct.memory_E(concentration,prev_concentration,prev_memory,elapsed_time,mtau)
